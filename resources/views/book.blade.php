...
<div class="container-fluid">
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <a href="{{route('admin.print.books') }}" target="_blank"
            class="btn btn-secondary"><i class=" fa-print"></i>Cetak PDF</a>
                    <hr />
                        ...
                        <td>
                            <div class="btn-group" role="group" arialabel="Basic example">
                                <button type="button" id="btn-edit-buku" class="btn btn-success" data-toggle="modal"
                                    datatarget="#editBukuModal" data-id="{{ $book->id }}">Edit</button>
                                <button type="button" id="btn-deletebuku" class="btn btn-danger">Hapus</button>
                            </div>
...
<div class="modal fade" id="editBukuModal" tabindex="-1" arialabelledby="exampleModalLabel" aria-hidden="true">
